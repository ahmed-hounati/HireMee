<x-app-layout>
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-900">
        <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
            <form class="mt-6" method="POST" action="/entreprise/emplois/{{$emploi->id}}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <!-- pic -->
                <div>
                    <x-input-label for="image" :value="__('image')" />
                    <x-text-input id="image" class="block mt-1 w-full" type="file" name="image" :value="old('image', $emploi->image) " required autofocus />
                ...
                <div>
                    ...
                    <x-text-input id="title" class="block mt-1 w-full" type="text" name="title" :value="old('title', $emploi->title)" required autofocus  />
                ...
                <div>
                    ...
                    <x-text-input id="description" class="block mt-1 w-full" type="text" name="description" :value="old('description', $emploi->description)" required autofocus  />
                ...
                <div class="flex items-center gap-2">
                    <div class="flex-grow">
                        ...
                        <x-text-input id="competences" class="block mt-1 w-full" type="text" name="competences[]" :value="old('competences[]', $emploi->competences)" required autofocus  />
                ...
                <div>
                    ...
                    <x-text-input id="emplacement" class="block mt-1 w-full" type="text" name="emplacement" :value="old('emplacement', $emploi->emplacement)" required autofocus autocomplete="name" />
